...
void testAddAnnotation(fz_context *ctx, pdf_document *doc, int pageno, char *savefile) {
    ...
    fz_try (ctx)  {
        ...
        fp = fps->point;
        fp->p.x = 776.703; fp->p.y = 628.713; fp->w = 0.5; fp ++;
        fp->p.x = 774.700; fp->p.y = 628.553; fp->w = 0.5415687; fp ++;
        fp->p.x = 772.697; fp->p.y = 628.392; fp->w = 0.5831374; fp ++;
        fp->p.x = 770.694; fp->p.y = 628.232; fp->w = 0.6247061; fp ++;
        fp->p.x = 768.691; fp->p.y = 628.072; fp->w = 0.6662748; fp ++;
        fp->p.x = 768.691; fp->p.y = 628.072; fp->w = 0.6662748; fp ++;
        fp->p.x = 767.022; fp->p.y = 628.047; fp->w = 0.6756242; fp ++;
        fp->p.x = 765.222; fp->p.y = 628.228; fp->w = 0.6849737; fp ++;
        fp->p.x = 763.289; fp->p.y = 628.616; fp->w = 0.6943232; fp ++;
        fp->p.x = 761.225; fp->p.y = 629.210; fp->w = 0.7036726; fp ++;
        fp->p.x = 759.028; fp->p.y = 630.011; fp->w = 0.7130221; fp ++;
        fp->p.x = 756.699; fp->p.y = 631.018; fp->w = 0.7223716; fp ++;
        fp->p.x = 754.239; fp->p.y = 632.231; fp->w = 0.7317210; fp ++;
        fp->p.x = 751.646; fp->p.y = 633.651; fp->w = 0.7410705; fp ++;
        fp->p.x = 748.921; fp->p.y = 635.277; fp->w = 0.7504200; fp ++;
        fp->p.x = 748.921; fp->p.y = 635.277; fp->w = 0.7504200; fp ++;
        fp->p.x = 745.676; fp->p.y = 637.825; fp->w = 0.7268964; fp ++;
        fp->p.x = 742.927; fp->p.y = 640.863; fp->w = 0.7033730; fp ++;
        fp->p.x = 740.675; fp->p.y = 644.391; fp->w = 0.6798495; fp ++;
        fp->p.x = 738.920; fp->p.y = 648.409; fp->w = 0.6563260; fp ++;
        fp->p.x = 737.661; fp->p.y = 652.917; fp->w = 0.6328025; fp ++;
        fp->p.x = 736.900; fp->p.y = 657.916; fp->w = 0.6092790; fp ++;
        fp->p.x = 736.635; fp->p.y = 663.405; fp->w = 0.5857556; fp ++;
        fp->p.x = 736.867; fp->p.y = 669.384; fp->w = 0.5622321; fp ++;
        fp->p.x = 737.596; fp->p.y = 675.854; fp->w = 0.5387085; fp ++;
        fp->p.x = 737.596; fp->p.y = 675.854; fp->w = 0.5387085; fp ++;
        fp->p.x = 739.716; fp->p.y = 684.186; fp->w = 0.5061289; fp ++;
        fp->p.x = 742.637; fp->p.y = 691.989; fp->w = 0.4735494; fp ++;
        fp->p.x = 746.359; fp->p.y = 699.264; fp->w = 0.4409698; fp ++;
        fp->p.x = 750.882; fp->p.y = 706.010; fp->w = 0.4083902; fp ++;
        fp->p.x = 756.206; fp->p.y = 712.226; fp->w = 0.3758106; fp ++;
        fp->p.x = 762.331; fp->p.y = 717.914; fp->w = 0.3432310; fp ++;
        fp->p.x = 769.257; fp->p.y = 723.073; fp->w = 0.3106514; fp ++;
        fp->p.x = 776.984; fp->p.y = 727.703; fp->w = 0.2780718; fp ++;
        fp->p.x = 785.513; fp->p.y = 731.803; fp->w = 0.2454922; fp ++;
        fp->p.x = 785.513; fp->p.y = 731.803; fp->w = 0.2454922; fp ++;
        fp->p.x = 796.804; fp->p.y = 735.406; fp->w = 0.2431225; fp ++;
        fp->p.x = 807.487; fp->p.y = 738.171; fp->w = 0.2407528; fp ++;
        fp->p.x = 817.562; fp->p.y = 740.098; fp->w = 0.2383831; fp ++;
        fp->p.x = 827.028; fp->p.y = 741.187; fp->w = 0.2360134; fp ++;
        fp->p.x = 835.887; fp->p.y = 741.437; fp->w = 0.2336438; fp ++;
        fp->p.x = 844.136; fp->p.y = 740.850; fp->w = 0.2312741; fp ++;
        fp->p.x = 851.778; fp->p.y = 739.424; fp->w = 0.2289044; fp ++;
        fp->p.x = 858.811; fp->p.y = 737.161; fp->w = 0.2265347; fp ++;
        fp->p.x = 865.236; fp->p.y = 734.059; fp->w = 0.2241650; fp ++;
        ...
        z_pdf_add_annotation(ctx, page, app, NULL,NULL);

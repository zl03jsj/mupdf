...
#endif
#endif
/* Header for class com_z_OpensslSignDevice */

#ifndef _Included_com_z_OpensslSignDevice
#define _Included_com_z_OpensslSignDevice
#ifdef __cplusplus
extern "C" {
#endif
/*
 * Class:     com_z_OpensslSignDevice
 * Method:    finalize
 * Signature: ()V
 */
...
#endif
#endif
/* Header for class com_z_PdfSignAppearance */

#ifndef _Included_com_z_PdfSignAppearance
#define _Included_com_z_PdfSignAppearance
#ifdef __cplusplus
extern "C" {
#endif
/*
 * Class:     com_z_PdfSignAppearance
 * Method:    finalize
 * Signature: ()V
 */
...
/*
 * Class:     com_z_PdfSignAppearance
 * Method:    newNativeWithImageFile
 * Signature: (Ljava/lang/String;Lcom/artifex/mupdf/fitz/Rect;)J
 */
...
/*
 * Class:     com_z_PdfSignAppearance
 * Method:    newNativeWithImageData
 * Signature: ([BLcom/artifex/mupdf/fitz/Rect;)J
 */
...
#endif
#endif
/* Header for class com_z_Pdfdocument */

#ifndef _Included_com_z_Pdfdocument
#define _Included_com_z_Pdfdocument
#ifdef __cplusplus
extern "C" {
#endif
#ifdef __cplusplus
...
#endif
#endif
/* Header for class example_Helper */

#ifndef _Included_example_Helper
#define _Included_example_Helper
#ifdef __cplusplus
extern "C" {
#endif
#ifdef __cplusplus
...
#endif
#endif
/* Header for class example_PageCanvas */

#ifndef _Included_example_PageCanvas
#define _Included_example_PageCanvas
#ifdef __cplusplus
extern "C" {
#endif
#undef example_PageCanvas_FOCUS_TRAVERSABLE_UNKNOWN
#define example_PageCanvas_FOCUS_TRAVERSABLE_UNKNOWN 0L
#undef example_PageCanvas_FOCUS_TRAVERSABLE_DEFAULT
#define example_PageCanvas_FOCUS_TRAVERSABLE_DEFAULT 1L
#undef example_PageCanvas_FOCUS_TRAVERSABLE_SET
#define example_PageCanvas_FOCUS_TRAVERSABLE_SET 2L
#undef example_PageCanvas_TOP_ALIGNMENT
#define example_PageCanvas_TOP_ALIGNMENT 0.0f
#undef example_PageCanvas_CENTER_ALIGNMENT
#define example_PageCanvas_CENTER_ALIGNMENT 0.5f
#undef example_PageCanvas_BOTTOM_ALIGNMENT
#define example_PageCanvas_BOTTOM_ALIGNMENT 1.0f
#undef example_PageCanvas_LEFT_ALIGNMENT
#define example_PageCanvas_LEFT_ALIGNMENT 0.0f
#undef example_PageCanvas_RIGHT_ALIGNMENT
#define example_PageCanvas_RIGHT_ALIGNMENT 1.0f
#undef example_PageCanvas_serialVersionUID
#define example_PageCanvas_serialVersionUID -7644114512714619750LL
#undef example_PageCanvas_serialVersionUID
#define example_PageCanvas_serialVersionUID -2284879212465893870LL
#undef example_PageCanvas_ViewModeNormal
#define example_PageCanvas_ViewModeNormal 0L
#undef example_PageCanvas_ViewModeImageSign
#define example_PageCanvas_ViewModeImageSign 1L
#undef example_PageCanvas_ViewModeHandSign
#define example_PageCanvas_ViewModeHandSign 2L
#ifdef __cplusplus
}
#endif
#endif
/* Header for class example_PdfPageViewMode */

#ifndef _Included_example_PdfPageViewMode
#define _Included_example_PdfPageViewMode
#ifdef __cplusplus
extern "C" {
#endif
#undef example_PdfPageViewMode_mode_normal
#define example_PdfPageViewMode_mode_normal 0L
#undef example_PdfPageViewMode_mode_image_sign
#define example_PdfPageViewMode_mode_image_sign 1L
#undef example_PdfPageViewMode_mode_hand_sign
#define example_PdfPageViewMode_mode_hand_sign 2L
#ifdef __cplusplus
}
#endif
#endif
/* Header for class example_Pdfsignature */

#ifndef _Included_example_Pdfsignature
#define _Included_example_Pdfsignature
#ifdef __cplusplus
extern "C" {
#endif
#ifdef __cplusplus
...
#endif
#endif
/* Header for class example_TraceDevice */

#ifndef _Included_example_TraceDevice
#define _Included_example_TraceDevice
#ifdef __cplusplus
extern "C" {
#endif
#undef example_TraceDevice_FLAG_MASK
#define example_TraceDevice_FLAG_MASK 1L
#undef example_TraceDevice_FLAG_COLOR
#define example_TraceDevice_FLAG_COLOR 2L
#undef example_TraceDevice_FLAG_UNCACHEABLE
#define example_TraceDevice_FLAG_UNCACHEABLE 4L
#undef example_TraceDevice_FLAG_FILLCOLOR_UNDEFINED
#define example_TraceDevice_FLAG_FILLCOLOR_UNDEFINED 8L
#undef example_TraceDevice_FLAG_STROKECOLOR_UNDEFINED
#define example_TraceDevice_FLAG_STROKECOLOR_UNDEFINED 16L
#undef example_TraceDevice_FLAG_STARTCAP_UNDEFINED
#define example_TraceDevice_FLAG_STARTCAP_UNDEFINED 32L
#undef example_TraceDevice_FLAG_DASHCAP_UNDEFINED
#define example_TraceDevice_FLAG_DASHCAP_UNDEFINED 64L
#undef example_TraceDevice_FLAG_ENDCAP_UNDEFINED
#define example_TraceDevice_FLAG_ENDCAP_UNDEFINED 128L
#undef example_TraceDevice_FLAG_LINEJOIN_UNDEFINED
#define example_TraceDevice_FLAG_LINEJOIN_UNDEFINED 256L
#undef example_TraceDevice_FLAG_MITERLIMIT_UNDEFINED
#define example_TraceDevice_FLAG_MITERLIMIT_UNDEFINED 512L
#undef example_TraceDevice_FLAG_LINEWIDTH_UNDEFINED
#define example_TraceDevice_FLAG_LINEWIDTH_UNDEFINED 1024L
#undef example_TraceDevice_BLEND_NORMAL
#define example_TraceDevice_BLEND_NORMAL 0L
#undef example_TraceDevice_BLEND_MULTIPLY
#define example_TraceDevice_BLEND_MULTIPLY 1L
#undef example_TraceDevice_BLEND_SCREEN
#define example_TraceDevice_BLEND_SCREEN 2L
#undef example_TraceDevice_BLEND_OVERLAY
#define example_TraceDevice_BLEND_OVERLAY 3L
#undef example_TraceDevice_BLEND_DARKEN
#define example_TraceDevice_BLEND_DARKEN 4L
#undef example_TraceDevice_BLEND_LIGHTEN
#define example_TraceDevice_BLEND_LIGHTEN 5L
#undef example_TraceDevice_BLEND_COLOR_DODGE
#define example_TraceDevice_BLEND_COLOR_DODGE 6L
#undef example_TraceDevice_BLEND_COLOR_BURN
#define example_TraceDevice_BLEND_COLOR_BURN 7L
#undef example_TraceDevice_BLEND_HARD_LIGHT
#define example_TraceDevice_BLEND_HARD_LIGHT 8L
#undef example_TraceDevice_BLEND_SOFT_LIGHT
#define example_TraceDevice_BLEND_SOFT_LIGHT 9L
#undef example_TraceDevice_BLEND_DIFFERENCE
#define example_TraceDevice_BLEND_DIFFERENCE 10L
#undef example_TraceDevice_BLEND_EXCLUSION
#define example_TraceDevice_BLEND_EXCLUSION 11L
#undef example_TraceDevice_BLEND_HUE
#define example_TraceDevice_BLEND_HUE 12L
#undef example_TraceDevice_BLEND_SATURATION
#define example_TraceDevice_BLEND_SATURATION 13L
#undef example_TraceDevice_BLEND_COLOR
#define example_TraceDevice_BLEND_COLOR 14L
#undef example_TraceDevice_BLEND_LUMINOSITY
#define example_TraceDevice_BLEND_LUMINOSITY 15L
#undef example_TraceDevice_BLEND_MODEMASK
#define example_TraceDevice_BLEND_MODEMASK 15L
#undef example_TraceDevice_BLEND_ISOLATED
#define example_TraceDevice_BLEND_ISOLATED 16L
#undef example_TraceDevice_BLEND_KNOCKOUT
#define example_TraceDevice_BLEND_KNOCKOUT 32L
#undef example_TraceDevice_IGNORE_IMAGE
#define example_TraceDevice_IGNORE_IMAGE 1L
#undef example_TraceDevice_IGNORE_SHADE
#define example_TraceDevice_IGNORE_SHADE 2L
#ifdef __cplusplus
}
#endif
#endif
/* Header for class example_Transparency */

#ifndef _Included_example_Transparency
#define _Included_example_Transparency
#ifdef __cplusplus
extern "C" {
#endif
#ifdef __cplusplus
...
#endif
#endif
/* Header for class example_Viewer */

#ifndef _Included_example_Viewer
#define _Included_example_Viewer
#ifdef __cplusplus
extern "C" {
#endif
#undef example_Viewer_FOCUS_TRAVERSABLE_UNKNOWN
#define example_Viewer_FOCUS_TRAVERSABLE_UNKNOWN 0L
#undef example_Viewer_FOCUS_TRAVERSABLE_DEFAULT
#define example_Viewer_FOCUS_TRAVERSABLE_DEFAULT 1L
#undef example_Viewer_FOCUS_TRAVERSABLE_SET
#define example_Viewer_FOCUS_TRAVERSABLE_SET 2L
#undef example_Viewer_TOP_ALIGNMENT
#define example_Viewer_TOP_ALIGNMENT 0.0f
#undef example_Viewer_CENTER_ALIGNMENT
#define example_Viewer_CENTER_ALIGNMENT 0.5f
#undef example_Viewer_BOTTOM_ALIGNMENT
#define example_Viewer_BOTTOM_ALIGNMENT 1.0f
#undef example_Viewer_LEFT_ALIGNMENT
#define example_Viewer_LEFT_ALIGNMENT 0.0f
#undef example_Viewer_RIGHT_ALIGNMENT
#define example_Viewer_RIGHT_ALIGNMENT 1.0f
#undef example_Viewer_serialVersionUID
#define example_Viewer_serialVersionUID -7644114512714619750LL
#undef example_Viewer_serialVersionUID
#define example_Viewer_serialVersionUID 4613797578919906343LL
#undef example_Viewer_INCLUDE_SELF
#define example_Viewer_INCLUDE_SELF 1L
#undef example_Viewer_SEARCH_HEAVYWEIGHTS
#define example_Viewer_SEARCH_HEAVYWEIGHTS 1L
#undef example_Viewer_OPENED
#define example_Viewer_OPENED 1L
#undef example_Viewer_serialVersionUID
#define example_Viewer_serialVersionUID 4497834738069338734LL
#undef example_Viewer_DEFAULT_CURSOR
#define example_Viewer_DEFAULT_CURSOR 0L
#undef example_Viewer_CROSSHAIR_CURSOR
#define example_Viewer_CROSSHAIR_CURSOR 1L
#undef example_Viewer_TEXT_CURSOR
#define example_Viewer_TEXT_CURSOR 2L
#undef example_Viewer_WAIT_CURSOR
#define example_Viewer_WAIT_CURSOR 3L
#undef example_Viewer_SW_RESIZE_CURSOR
#define example_Viewer_SW_RESIZE_CURSOR 4L
#undef example_Viewer_SE_RESIZE_CURSOR
#define example_Viewer_SE_RESIZE_CURSOR 5L
#undef example_Viewer_NW_RESIZE_CURSOR
#define example_Viewer_NW_RESIZE_CURSOR 6L
#undef example_Viewer_NE_RESIZE_CURSOR
#define example_Viewer_NE_RESIZE_CURSOR 7L
#undef example_Viewer_N_RESIZE_CURSOR
#define example_Viewer_N_RESIZE_CURSOR 8L
#undef example_Viewer_S_RESIZE_CURSOR
#define example_Viewer_S_RESIZE_CURSOR 9L
#undef example_Viewer_W_RESIZE_CURSOR
#define example_Viewer_W_RESIZE_CURSOR 10L
#undef example_Viewer_E_RESIZE_CURSOR
#define example_Viewer_E_RESIZE_CURSOR 11L
#undef example_Viewer_HAND_CURSOR
#define example_Viewer_HAND_CURSOR 12L
#undef example_Viewer_MOVE_CURSOR
#define example_Viewer_MOVE_CURSOR 13L
#undef example_Viewer_NORMAL
#define example_Viewer_NORMAL 0L
#undef example_Viewer_ICONIFIED
#define example_Viewer_ICONIFIED 1L
#undef example_Viewer_MAXIMIZED_HORIZ
#define example_Viewer_MAXIMIZED_HORIZ 2L
#undef example_Viewer_MAXIMIZED_VERT
#define example_Viewer_MAXIMIZED_VERT 4L
#undef example_Viewer_MAXIMIZED_BOTH
#define example_Viewer_MAXIMIZED_BOTH 6L
#undef example_Viewer_serialVersionUID
#define example_Viewer_serialVersionUID 2673458971256075116LL
#ifdef __cplusplus
}
#endif
#endif

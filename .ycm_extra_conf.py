...
flags = [
#'-Wall','-Wextra','-Werror',
'-Wno-unused-variable', '-Wno-long-long', '-Wno-variadic-macros', '-fexceptions',
# following flags are used by mupdf's 'MakeFile'
'-ffunction-sections', '-fdata-sections', '-pipe', '-O2', '-DNDEBUG', '-fomit-frame-pointer',
